...
bsp.i_getNamespace('bsp._unified_ns.tools_ns.variables_ns').i_importJSStringToolsClass = function()
{
	var _ns = bsp._unified_ns.controller_ns.tools_ns;
	//INIT...
	if (_ns.JSStringTools)
	{
		return _ns.JSStringTools;
	}

	//INHERITANCE IMPORT...
	//...INHERITANCE IMPORT

	_ns.JSStringTools = function()
	{
		___constructor.call(this);
	};
	var _self = _ns.JSStringTools;
	...
	_private._initJSStringTools = function()
	{
	};
	//...INIT
