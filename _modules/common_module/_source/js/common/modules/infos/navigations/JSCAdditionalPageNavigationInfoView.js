bsp.i_getNamespace('bsp.modules_ns.infos_ns.navigations_ns').i_importJSInfoViewClass = function()
{
	var _ns = bsp.modules_ns.infos_ns.navigations_ns;
	//INIT...
	if (_ns.JSInfoView)
	{
		return _ns.JSInfoView;
	}
	...
	_ns.JSInfoView = function()
	{
		___constructor.call(this);
	};
	var _self = _ns.JSInfoView;
	...
	_private._initCInfoView = function()
	{
