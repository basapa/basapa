bsp.i_getNamespace('bsp.modules_ns.infos_ns').i_importJSCExternalRedirectInfoViewClass = function()
{
	var _ns = bsp.modules_ns.infos_ns;
	//INIT...
	if (_ns.JSCExternalRedirectInfoView)
	{
		return _ns.JSCExternalRedirectInfoView;
	}
	...
	_ns.JSCExternalRedirectInfoView = function()
	{
		___constructor.call(this);
	};
	var _self = _ns.JSCExternalRedirectInfoView;
	...
	___constructor = function()
	{
		...
		this._initJSCExternalRedirectInfoView();
	};
	...
	_private._initJSCExternalRedirectInfoView = function()
	{
	};
	//...INIT
	...
	_override_protected.__initDOMInfo = function()
	{
		...
		//lSupportButtonFormComponent_clss.i_addEventListener(JSCComponentView.i_NATIVE_EVENT_ID_CLICK, new JSEventHandler(this, this._onSupportButtonComponentClick));
	};
	//...PROTECTED
