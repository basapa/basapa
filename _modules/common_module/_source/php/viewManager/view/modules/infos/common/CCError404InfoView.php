...
final class CCError404InfoView extends CCInfoView
{
	//JS PHP AGREEMENTS...
	//...JS PHP AGREEMENTS

	//IDS...
	private const _INFO_ID								= 'error_404_info_id';
	private const _INFO_COMPONENT_ID_TITLE				= self::_INFO_ID. '_01';
	private const _INFO_COMPONENT_ID_DESCRIPTION		= self::_INFO_ID. '_02';
	//...IDS
	
	//CSS...
	private const _CSS_INFO								= 'css_error_404_info';
	//...CSS
	...
	/*override*/protected function __drawHeaderContent():void
	{
		...
		$lInfoTranslationData_clss = $lTranslationData_clss->i_getInfosTranslationData()->i_getError404TextInfoTranslationData();
	...
	/*override*/protected function __drawBodyContent():void
	{
		...
		$lFullFileName_str = CStringTools::i_replace(CCFileConst::i_INTERNALS_TRANSLATIONS_ERRORS_TEXTS_DIRECTORY_NAME . CCFileConst::i_ERROR_404_TEXT_FILE_NAME, $lLangId_str, CStringTools::i_REPLACING_PATTERN_LANG_ID);
