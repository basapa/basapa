...
final class CCAccessProhibitionInfoView extends CCInfoView
{
	//JS PHP AGREEMENTS...
	//...JS PHP AGREEMENTS

	//IDS...
	private const _INFO_ID								= 'access_prohibition_info_id';
	private const _INFO_COMPONENT_ID_TITLE				= self::_INFO_ID. '_01';
	private const _INFO_COMPONENT_ID_DESCRIPTION		= self::_INFO_ID. '_02';
	//...IDS
	
	//CSS...
	private const _CSS_INFO								= 'css_access_prohibition_info';
	//...CSS
	...
	/*override*/protected function __getJSInfoImport():string
{
	...
	/*override*/protected function __drawHeaderContent():void
	{
		...
		$lInfoTranslationData_clss = $lTranslationData_clss->i_getInfosTranslationData()->i_getAccessProhibitionTextInfoTranslationData();
	...
	/*override*/protected function __drawBodyContent():void
	{
		...
		$lFullFileName_str = CStringTools::i_replace(CCFileConst::i_INTERNALS_TRANSLATIONS_ACCESSES_TEXTS_DIRECTORY_NAME . CCFileConst::i_ACCESS_PROHIBITION_TEXT_FILE_NAME, $lLangId_str, CStringTools::i_REPLACING_PATTERN_LANG_ID);
