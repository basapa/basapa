...
abstract class CCTextfieldComponentView extends CCFormComponentView
{
	//PARAM IDS...
	public const i_PARAM_ID_VALUE						= 'value';
	public const i_PARAM_ID_MAX_CHARS_COUNT				= 'max_chars_count';
	public const i_PARAM_ID_OPT_PLACEHOLDER				= 'placeholder';
	//...PARAM IDS
	...
	//CSS...
	private const _CSS_COMPONENT						= 'css_textfield_component';
	...
	private function _getComponentValueVar(bool $aOptThrowIfNotExist_bl = true)
	{
		...
		return $this->__getParamValue(self::i_PARAM_ID_VALUE, $aOptThrowIfNotExist_bl);
	}
	...
	{
		//TODO: optimization required
		return $this->__getParamValue(self::i_PARAM_ID_MAX_CHARS_COUNT, $aOptThrowIfNotExist_bl);
	}
	...
	{
		//TODO: optimization required
		return CVariableTools::i_toString($this->__getParamValue(self::i_PARAM_ID_OPT_PLACEHOLDER, false, ''));
	}
	//...PARAMS
}
