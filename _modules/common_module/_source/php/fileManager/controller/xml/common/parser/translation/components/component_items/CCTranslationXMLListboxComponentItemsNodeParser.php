...
final class CCTranslationXMLListboxComponentItemsNodeParser extends CCTranslationXMLComponentItemsNodeParser
{
	...
	{
		return new CCTranslationXMLListboxComponentItemsNode($aNameNode_str, $aOptParentNode_clss);
	}
