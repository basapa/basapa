...
final class CCTranslationXMLImageComponentNodeParser extends CCTranslationXMLComponentNodeParser
{
	...
	{
		return new CCTranslationXMLImageComponentNode($aNameNode_str, $aOptParentNode_clss);
	}
	...
	/*override*/protected static function __parseChildNode(string $aChildNodeName_str, CSimpleXMLElementWrapper $aChildNode_clss, CCXMLNode $aParentNode_clss):void
	{
		switch ($aChildNodeName_str)
		{
			...
			{
				$aParentNode_clss->i_insertNode(parent::i_parseSimpleNode($aChildNode_clss, $aChildNodeName_str, $aParentNode_clss), CCTranslationXMLImageComponentNode::i_CHILD_NODE_INDEX_NAME);
			}break;
