...
final class CCTranslationXMLTextComponentNodeParser extends CCTranslationXMLComponentNodeParser
{
	/***************************************************
	 * INTERFACE
	 */
	...
	{
		return new CCTranslationXMLTextComponentNode($aNameNode_str, $aOptParentNode_clss);
	}
