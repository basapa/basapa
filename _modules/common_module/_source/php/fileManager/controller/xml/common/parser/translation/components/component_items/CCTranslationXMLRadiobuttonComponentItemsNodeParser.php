...
final class CCTranslationXMLRadiobuttonComponentItemsNodeParser extends CCTranslationXMLComponentItemsNodeParser
{
	...
	{
		return new CCTranslationXMLRadiobuttonComponentItemsNode($aNameNode_str, $aOptParentNode_clss);
	}
