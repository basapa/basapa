...
final class CCTranslationXMLLabelfieldComponentNodeParser extends CCTranslationXMLComponentNodeParser
{
	...
	{
		return new CCTranslationXMLLabelfieldComponentNode($aNameNode_str, $aOptParentNode_clss);
	}
	...
	/*override*/protected static function __parseChildNode(string $aChildNodeName_str, CSimpleXMLElementWrapper $aChildNode_clss, CCXMLNode $aParentNode_clss):void
	{
		switch ($aChildNodeName_str)
		{
			...
			{
				$aParentNode_clss->i_insertNode(parent::i_parseSimpleNode($aChildNode_clss, $aChildNodeName_str, $aParentNode_clss), CCTranslationXMLLabelfieldComponentNode::i_CHILD_NODE_INDEX_NAME);
			}break;
