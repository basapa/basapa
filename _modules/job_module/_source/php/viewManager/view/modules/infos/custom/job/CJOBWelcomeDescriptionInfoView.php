...
final class CJOBWelcomeDescriptionInfoView extends CCInfoView
{
	//JS PHP AGREEMENTS...
	//...JS PHP AGREEMENTS

	//IDS...
	private const _INFO_ID								= 'job_welcome_description_info_id';
	private const _INFO_COMPONENT_ID_CAPTION			= self::_INFO_ID. '_01';
	private const _INFO_COMPONENT_ID_DESCRIPTION		= self::_INFO_ID. '_02';
	//...IDS

	//CSS...
	private const _CSS_INFO								= 'css_job_welcome_description_info';
	//...CSS
	...
	//TRANSLATIONS...
	private const _INFO_XML_NODE_ID						= 'welcome_description_info';
	...
	/*override*/protected function __getJSInfo():string
	{
		...
		return 'bsp.main.i_getSiteView(\'' .$lSiteId_str. '\').i_getPagesView().i_getPageView(\'' .$lPageId_str. '\').i_getInfosView().i_getWelcomeDescriptionInfoView()';*/
