...
final class CContentInfoView extends CCInfoView
{
	//JS PHP AGREEMENTS...
	//...JS PHP AGREEMENTS
	...
	//CSS...
	private const _CSS_INFO								= 'css_JOB_JOB_content_info';
	//...CSS
	...
	/*override*/protected function __drawBodyContent():void
	{
		...
		$lContentTableData_clss = CContentTableData::i_toClassType($lContentTableData_clss);
