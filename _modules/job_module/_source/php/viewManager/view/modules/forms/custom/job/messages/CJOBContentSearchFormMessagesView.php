...
final class CJOBContentSearchFormMessagesView extends CCFormMessagesView
{
	/***************************************************
	 * INTERFACE
	 */
	...
	protected function __getFormMessagesData():CCFormMessagesData
	{
		...
		return $lFormsMessagesData_clss->i_getContentSearchFormMessagesData();
	}
	...
	protected function __getFormTranslationData():CCTranslationXMLFormNode
	{
		...
		return $lFormsTranslationData_clss->i_getContentSearchFormTranslationData();
	}
}
