...
final class CJOBContentEditionFormMessagesView extends CCFormMessagesView
{
	/***************************************************
	 * INTERFACE
	 */
	...
	protected function __getFormMessagesData():CCFormMessagesData
	{
		...
		return $lFormsMessagesData_clss->i_getContentEditionFormMessagesData();
	}
	...
	protected function __getFormTranslationData():CCTranslationXMLFormNode
	{
		...
		return $lFormsTranslationData_clss->i_getContentEditionFormTranslationData();
	}
}
