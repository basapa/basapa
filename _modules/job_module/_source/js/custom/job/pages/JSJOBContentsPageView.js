bsp.i_getNamespace('bsp.job_ns.pages_ns').i_importJSJOBContentsPageViewClass = function()
{
	var _ns = bsp.job_ns.pages_ns;
	//INIT...
	if (_ns.JSJOBContentsPageView)
	{
		return _ns.JSJOBContentsPageView;
	}
	...
	_ns.JSJOBContentsPageView = function()
	{
		___constructor.call(this);
	};
	var _self = _ns.JSJOBContentsPageView;
	...
	___constructor = function()
	{
		...
		this._initJSJOBContentsPageView();
	};
	...
	_private._initJSJOBContentsPageView = function()
	{
	};
	//...INIT
