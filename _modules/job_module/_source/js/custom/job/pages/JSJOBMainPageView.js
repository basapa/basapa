bsp.i_getNamespace('bsp.job_ns.pages_ns').i_importJSJOBMainPageViewClass = function()
{
	var _ns = bsp.job_ns.pages_ns;
	//INIT...
	if (_ns.JSJOBMainPageView)
	{
		return _ns.JSJOBMainPageView;
	}
	...
	_ns.JSJOBMainPageView = function()
	{
		___constructor.call(this);
	};
	var _self = _ns.JSJOBMainPageView;
	...
	_private._initJSJOBMainPageView = function()
	{
	};
	//...INIT
