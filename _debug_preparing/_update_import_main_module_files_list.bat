...
set file_name=main_import

::JS
set js_source_path=%source_path%\js\custom\main

del %js_source_path%\%file_name%.js
start /B %compiler% CMD:CREATE_JS_CLASSES_IMPORT_FILE OUT_DIRECTORY:%js_source_path% OUT_FILE:.\%file_name%.js SOURCE_DIRECTORY:%js_source_path% AUX_SOURCE_DIRECTORY:\_source\js\custom\main
